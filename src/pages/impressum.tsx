...
const impressum: React.FC<impressumProps> = ({}) => {
  return (
    <>
      <h1 className='adsimple-321241781'>Impressum</h1>
      <p className='adsimple-321241781'>Informationspflicht laut § 5 TMG.</p>
      <p className='adsimple-321241781'>
        <p>Max Mustermann</p>
        <p className='adsimple-321241781'>
        ...
        <p className='adsimple-321241781'>
          ...
          <a href='mailto:office@musterfirma.de'>office@musterfirma.de</a>
        </p>
        <h2 className='adsimple-321241781'>EU-Streitschlichtung</h2>
        <p>
          ...
          <a
            ...
            rel='noopener'
          >
            http://ec.europa.eu/odr?tid=321241781
          </a>{' '}
        ...
        <h2 className='adsimple-321241781'>
        ...
        <p>
          ...
          <a
            className='adsimple-321241781'
            href='https://www.gesetze-im-internet.de/tmg/__7.html?tid=321241781'
            rel='noopener'
            target='_blank'
          >
            (TMG) §7 (1)
        ...
        <h2 className='adsimple-321241781'>Urheberrechtshinweis</h2>
        <p>
        ...
        <h2 className='adsimple-321241781'>Bildernachweis</h2>
        <p>
        ...
        <ul className='adsimple-321241781'>
          <li className='adsimple-321241781'>Fotograf Mustermann</li>
        </ul>
        <h1 className='adsimple-321241781'>Datenschutzerklärung</h1>
        <h2 className='adsimple-321241781'>Datenschutz</h2>
        <p>
          Wir haben diese Datenschutzerklärung (Fassung 16.12.2020-321241781)
          verfasst, um Ihnen gemäß der Vorgaben der{' '}
          <a
            className='adsimple-321241781'
            href='https://eur-lex.europa.eu/legal-content/DE/ALL/?uri=celex%3A32016R0679&amp;tid=321241781'
            target='_blank'
            rel='noopener'
          >
        ...
        <h2 className='adsimple-321241781'>Automatische Datenspeicherung</h2>
        <p>
        ...
        <ul className='adsimple-321241781'>
          <li className='adsimple-321241781'>
            die Adresse (URL) der aufgerufenen Webseite
          </li>
          <li className='adsimple-321241781'>Browser und Browserversion</li>
          <li className='adsimple-321241781'>das verwendete Betriebssystem</li>
          <li className='adsimple-321241781'>
          ...
          <li className='adsimple-321241781'>Datum und Uhrzeit</li>
        </ul>
        ...
        <h2 className='adsimple-321241781'>Speicherung persönlicher Daten</h2>
        <p>
        ...
        <p>
          ...
          <a
            className='adsimple-321241781'
            href='https://eur-lex.europa.eu/legal-content/DE/TXT/HTML/?uri=CELEX:32016R0679&amp;from=DE&amp;tid=321241781'
            target='_blank'
            rel='noopener'
          >
