...
import OkV from '../Ok/OkV'
import RadioCardC from '../RadioCard/RadioCardC'
import RadioToastC from '../RadioToast/RadioToastC'
import SentenceV from '../Sentence/SentenceV'
import CardTable from '../CardTable/CardTable'
import ToastTable from '../ToastTable/ToastTable'
import PageWrapV from '../PageWrap/PageWrapV'
...
import ButtonGroupV from '../ButtonGroup/ButtonGroupV'
...
const AppV: React.FC<AppVProps> = ({ demo }) => {
...
export default withApollo({ ssr: true })(AppV)
